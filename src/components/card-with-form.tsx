  ...
  return (
    <Card className="bg-[#1A1A17] text-white opacity-90 p-8 border-none flex flex-col gap-4 w-full max-w-[550px]">
      <CardHeader>
        ...
        <CardDescription className="text-[16px]">Deploy your new project in one-click.</CardDescription>
...
function Deploy(props: DeployProps) {
  ...
  return (
      <Button className="flex items-center gap-1 p-4" type="submit" {...props} aria-disabled={creating} onClick={create}>
        <span>create</span>
